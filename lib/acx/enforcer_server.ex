defmodule Acx.EnforcerServer.Behaviour do
  @moduledoc """
  Behaviour module that defines the EnforcerServer interface
  """

  defmacro __using__(opts) do
    enforcer_module = Keyword.get(opts, :enforcer_module, Acx.Enforcer)

    quote do
      use GenServer
      require Logger
      alias unquote(enforcer_module), as: Enforcer
      ...
      def child_spec(ename, cfile) do
        %{
          id: __MODULE__,
          start: {__MODULE__, :start_link, [ename, cfile]},
          restart: :permanent
        }
      end
    end
